...
public class UnifiedAgentCounterCollectorResource extends Resource {

	public UnifiedAgentCounterCollectorResource (Context context, Request request, Response response) {
		...
		try {
			...
			if (rawData.startsWith("{") && rawData.endsWith("}")) {
				...
				if (joRawData.containsKey("counterMessage")) {
					...
					bQueued = collectorManager.collectUnifiedAgentCounters(joCounterData);
					if( bQueued ) {
