 ...
 *
 */
public class PGSlowQueryDBI {
	
	private String strPGSlowQueriesQry = null;
...
//	private PreparedStatement psPGSlowQueries = null;
	...
	private Statement stmtPGSlowQueries = null;
...
//	private String strUID = "";
	...
	public void initializeInsertBatch(Connection con) throws Exception {
		...
		try{
			strPGSlowQueriesQry = "INSERT INTO postgres_slowQuery_@KEY@ (uid, appedo_received_on, Query, calls, duration_ms) VALUES ";
			
			stmtPGSlowQueries = con.createStatement();
	...
	public void addCounterBatch(Connection con, long lUID, String strQuery, long lCalls, long lDuration_ms) throws Exception {
		...
		try{
			sbQuery.append(strPGSlowQueriesQry.replaceAll("@KEY@", strPartitionKey))
					.append("(")
					.append(lUID).append(", ")
			...
			stmtPGSlowQueries.addBatch(sbQuery.toString());
...
//					psPGSlowQueries = hmPreStmtPGSlowQueries.get(strPartitionKey);
					...
					ins = stmtPGSlowQueries.executeBatch();
...
//		iterKeys = null;
	...
	public void execute(Connection con, long lUID, String strQuery, long lCalls, long lDuration_ms) throws Exception {
		...
		try{
			...
			stmtPGSlowQueries.executeUpdate(sbQuery.toString());
	...
	public void clearPreparedStatement() {
		DataBaseManager.close(stmtPGSlowQueries);
		stmtPGSlowQueries = null;
